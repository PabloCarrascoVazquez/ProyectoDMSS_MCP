 ...
 * @generated
 */
public class AgenteItemSemanticEditPolicy extends McpMM.diagram.edit.policies.McpMMBaseItemSemanticEditPolicy {

	/**
	* @generated
	*/
	public AgenteItemSemanticEditPolicy() {
		super(McpMM.diagram.providers.McpMMElementTypes.Agente_2002);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (McpMM.diagram.part.McpMMVisualIDRegistry
					.getVisualID(outgoingLink) == McpMM.diagram.edit.parts.AgenteRealizaEditPart.VISUAL_ID) {
