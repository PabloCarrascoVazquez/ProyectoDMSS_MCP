 ...
 * @generated
 */
public class TareaFinalItemSemanticEditPolicy extends McpMM.diagram.edit.policies.McpMMBaseItemSemanticEditPolicy {

	/**
	* @generated
	*/
	public TareaFinalItemSemanticEditPolicy() {
		super(McpMM.diagram.providers.McpMMElementTypes.TareaFinal_3011);
	}
	...
	*/
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (McpMM.diagram.part.McpMMVisualIDRegistry
					.getVisualID(incomingLink) == McpMM.diagram.edit.parts.WorkflowFinalizaConEditPart.VISUAL_ID) {
				DestroyReferenceRequest r = new DestroyReferenceRequest(incomingLink.getSource().getElement(), null,
						incomingLink.getTarget().getElement(), false);
				cmd.add(new DestroyReferenceCommand(r));
				cmd.add(new DeleteCommand(getEditingDomain(), incomingLink));
