 ...
 * @generated
 */
public class WorkflowItemSemanticEditPolicy extends McpMM.diagram.edit.policies.McpMMBaseItemSemanticEditPolicy {
				...
				for (Iterator<?> cit = node.getChildren().iterator(); cit.hasNext();) {
					...
					case McpMM.diagram.edit.parts.TareaTransformacionDatosEditPart.VISUAL_ID:
						for (Iterator<?> it = cnode.getTargetEdges().iterator(); it.hasNext();) {
							...
							if (McpMM.diagram.part.McpMMVisualIDRegistry.getVisualID(
									incomingLink) == McpMM.diagram.edit.parts.TareaAnalisisSigueElseEditPart.VISUAL_ID) {
								DestroyReferenceRequest r = new DestroyReferenceRequest(
										incomingLink.getSource().getElement(), null,
										incomingLink.getTarget().getElement(), false);
								cmd.add(new DestroyReferenceCommand(r));
						...
						for (Iterator<?> it = cnode.getSourceEdges().iterator(); it.hasNext();) {
							Edge outgoingLink = (Edge) it.next();
							if (McpMM.diagram.part.McpMMVisualIDRegistry.getVisualID(
									outgoingLink) == McpMM.diagram.edit.parts.TareaSigueEditPart.VISUAL_ID) {
								DestroyReferenceRequest r = new DestroyReferenceRequest(
					...
					case McpMM.diagram.edit.parts.TareaAnalisisEditPart.VISUAL_ID:
						...
						for (Iterator<?> it = cnode.getSourceEdges().iterator(); it.hasNext();) {
							...
							if (McpMM.diagram.part.McpMMVisualIDRegistry.getVisualID(
									outgoingLink) == McpMM.diagram.edit.parts.TareaAnalisisSigueElseEditPart.VISUAL_ID) {
								DestroyReferenceRequest r = new DestroyReferenceRequest(
										outgoingLink.getSource().getElement(), null,
										outgoingLink.getTarget().getElement(), false);
								cmd.add(new DestroyReferenceCommand(r));
					...
					case McpMM.diagram.edit.parts.TareaEnvioContextoEditPart.VISUAL_ID:
						...
						for (Iterator<?> it = cnode.getSourceEdges().iterator(); it.hasNext();) {
							...
							if (McpMM.diagram.part.McpMMVisualIDRegistry.getVisualID(
									outgoingLink) == McpMM.diagram.edit.parts.TareaEnvioContextoEnviaAEditPart.VISUAL_ID) {
								DestroyReferenceRequest r = new DestroyReferenceRequest(
										outgoingLink.getSource().getElement(), null,
										outgoingLink.getTarget().getElement(), false);
								cmd.add(new DestroyReferenceCommand(r));
					...
					case McpMM.diagram.edit.parts.TareaRecepcionContextoEditPart.VISUAL_ID:
						for (Iterator<?> it = cnode.getTargetEdges().iterator(); it.hasNext();) {
							...
							if (McpMM.diagram.part.McpMMVisualIDRegistry.getVisualID(
									incomingLink) == McpMM.diagram.edit.parts.TareaEnvioContextoEnviaAEditPart.VISUAL_ID) {
								DestroyReferenceRequest r = new DestroyReferenceRequest(
										incomingLink.getSource().getElement(), null,
										incomingLink.getTarget().getElement(), false);
								cmd.add(new DestroyReferenceCommand(r));
						...
						for (Iterator<?> it = cnode.getSourceEdges().iterator(); it.hasNext();) {
							...
							if (McpMM.diagram.part.McpMMVisualIDRegistry.getVisualID(
									outgoingLink) == McpMM.diagram.edit.parts.TareaRecepcionContextoRecibeDeEditPart.VISUAL_ID) {
								DestroyReferenceRequest r = new DestroyReferenceRequest(
										outgoingLink.getSource().getElement(), null,
										outgoingLink.getTarget().getElement(), false);
								cmd.add(new DestroyReferenceCommand(r));
							...
							if (McpMM.diagram.part.McpMMVisualIDRegistry.getVisualID(
									outgoingLink) == McpMM.diagram.edit.parts.TareaRecepcionContextoRecepcionAsociadaEditPart.VISUAL_ID) {
								DestroyReferenceRequest r = new DestroyReferenceRequest(
										outgoingLink.getSource().getElement(), null,
										outgoingLink.getTarget().getElement(), false);
								cmd.add(new DestroyReferenceCommand(r));
					...
					case McpMM.diagram.edit.parts.TareaServerMCPEditPart.VISUAL_ID:
						...
						for (Iterator<?> it = cnode.getSourceEdges().iterator(); it.hasNext();) {
							...
							if (McpMM.diagram.part.McpMMVisualIDRegistry.getVisualID(
									outgoingLink) == McpMM.diagram.edit.parts.TareaServerMCPEjecutaOperacionEditPart.VISUAL_ID) {
								DestroyReferenceRequest r = new DestroyReferenceRequest(
										outgoingLink.getSource().getElement(), null,
										outgoingLink.getTarget().getElement(), false);
								cmd.add(new DestroyReferenceCommand(r));
