 ...
 * @generated
 */
public class TareaAnalisisItemSemanticEditPolicy extends McpMM.diagram.edit.policies.McpMMBaseItemSemanticEditPolicy {

	/**
	* @generated
	*/
	public TareaAnalisisItemSemanticEditPolicy() {
		super(McpMM.diagram.providers.McpMMElementTypes.TareaAnalisis_3007);
	}
	...
	*/
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (McpMM.diagram.part.McpMMVisualIDRegistry
					.getVisualID(outgoingLink) == McpMM.diagram.edit.parts.TareaAnalisisSigueElseEditPart.VISUAL_ID) {
				DestroyReferenceRequest r = new DestroyReferenceRequest(outgoingLink.getSource().getElement(), null,
						outgoingLink.getTarget().getElement(), false);
				cmd.add(new DestroyReferenceCommand(r));
				cmd.add(new DeleteCommand(getEditingDomain(), outgoingLink));
