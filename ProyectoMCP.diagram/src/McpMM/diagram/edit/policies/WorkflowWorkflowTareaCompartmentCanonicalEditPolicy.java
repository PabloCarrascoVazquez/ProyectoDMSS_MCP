 ...
 * @generated
 */
public class WorkflowWorkflowTareaCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return McpMM.McpMMPackage.eINSTANCE.getWorkflow_Tarea();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<McpMM.diagram.part.McpMMNodeDescriptor> childDescriptors = McpMM.diagram.part.McpMMDiagramUpdater
				.getWorkflowWorkflowTareaCompartment_7003SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<McpMM.diagram.part.McpMMNodeDescriptor> childDescriptors = McpMM.diagram.part.McpMMDiagramUpdater
				.getWorkflowWorkflowTareaCompartment_7003SemanticChildren((View) getHost().getModel());
