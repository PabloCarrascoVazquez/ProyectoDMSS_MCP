 ...
 * @generated
 */
public class ServiceMCPCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<McpMM.diagram.part.McpMMNodeDescriptor> childDescriptors = McpMM.diagram.part.McpMMDiagramUpdater
				.getServiceMCP_1000SemanticChildren(viewObject);
	...
	*/
	protected boolean isOrphaned(Collection<EObject> semanticChildren, final View view) {
		if (isShortcut(view)) {
			return McpMM.diagram.part.McpMMDiagramUpdater.isShortcutOrphaned(view);
		}
	...
	*/
	protected void refreshSemantic() {
		...
		List<McpMM.diagram.part.McpMMNodeDescriptor> childDescriptors = McpMM.diagram.part.McpMMDiagramUpdater
				.getServiceMCP_1000SemanticChildren((View) getHost().getModel());
		LinkedList<View> orphaned = new LinkedList<View>();
		// we care to check only views we recognize as ours and not shortcuts
		LinkedList<View> knownViewChildren = new LinkedList<View>();
		for (View v : getViewChildren()) {
			if (isShortcut(v)) {
				if (McpMM.diagram.part.McpMMDiagramUpdater.isShortcutOrphaned(v)) {
					orphaned.add(v);
				}
				continue;
			}
		...
		for (Iterator<McpMM.diagram.part.McpMMNodeDescriptor> descriptorsIterator = childDescriptors
				.iterator(); descriptorsIterator.hasNext();) {
			McpMM.diagram.part.McpMMNodeDescriptor next = descriptorsIterator.next();
			String hint = McpMM.diagram.part.McpMMVisualIDRegistry.getType(next.getVisualID());
		...
		for (McpMM.diagram.part.McpMMNodeDescriptor next : childDescriptors) {
			String hint = McpMM.diagram.part.McpMMVisualIDRegistry.getType(next.getVisualID());
	...
	*/
	private Collection<IAdaptable> refreshConnections() {
		...
		Collection<McpMM.diagram.part.McpMMLinkDescriptor> linkDescriptors = collectAllLinks(getDiagram(),
				domain2NotationMap);
		Collection existingLinks = new LinkedList(getDiagram().getEdges());
		for (Iterator linksIterator = existingLinks.iterator(); linksIterator.hasNext();) {
			Edge nextDiagramLink = (Edge) linksIterator.next();
			int diagramLinkVisualID = McpMM.diagram.part.McpMMVisualIDRegistry.getVisualID(nextDiagramLink);
			...
			for (Iterator<McpMM.diagram.part.McpMMLinkDescriptor> linkDescriptorsIterator = linkDescriptors
					.iterator(); linkDescriptorsIterator.hasNext();) {
				McpMM.diagram.part.McpMMLinkDescriptor nextLinkDescriptor = linkDescriptorsIterator.next();
	...
	* @generated
	*/
	private Collection<McpMM.diagram.part.McpMMLinkDescriptor> collectAllLinks(View view,
		...
		case McpMM.diagram.edit.parts.ServiceMCPEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(McpMM.diagram.part.McpMMDiagramUpdater.getServiceMCP_1000ContainedLinks(view));
			}
	...
	* @generated
	*/
	private Collection<IAdaptable> createConnections(Collection<McpMM.diagram.part.McpMMLinkDescriptor> linkDescriptors,
			Domain2Notation domain2NotationMap) {
		LinkedList<IAdaptable> adapters = new LinkedList<IAdaptable>();
		for (McpMM.diagram.part.McpMMLinkDescriptor nextLinkDescriptor : linkDescriptors) {
			...
			CreateConnectionViewRequest.ConnectionViewDescriptor descriptor = new CreateConnectionViewRequest.ConnectionViewDescriptor(
					...
					McpMM.diagram.part.McpMMVisualIDRegistry.getType(nextLinkDescriptor.getVisualID()), ViewUtil.APPEND,
	...
	*/
	protected final EditPart getHintedEditPart(EObject domainModelElement, Domain2Notation domain2NotationMap,
		...
		View view = (View) domain2NotationMap.getHinted(domainModelElement,
				McpMM.diagram.part.McpMMVisualIDRegistry.getType(hintVisualId));
		if (view != null) {
			return (EditPart) getHost().getViewer().getEditPartRegistry().get(view);
		}
		return null;
