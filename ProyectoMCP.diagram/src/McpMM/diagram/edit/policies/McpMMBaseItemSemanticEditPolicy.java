 ...
 * @generated
 */
public class McpMMBaseItemSemanticEditPolicy extends SemanticEditPolicy {
	...
	* @generated
	*/
	protected McpMMBaseItemSemanticEditPolicy(IElementType elementType) {
	...
	public Command getCommand(Request request) {
		if (request instanceof ReconnectRequest) {
			...
			if (view instanceof View) {
				Integer id = new Integer(McpMM.diagram.part.McpMMVisualIDRegistry.getVisualID((View) view));
	...
	*/
	private IElementType getContextElementType(IEditCommandRequest request) {
		IElementType requestContextElementType = McpMM.diagram.providers.McpMMElementTypes
	...
	*/
	public static LinkConstraints getLinkConstraints() {
		LinkConstraints cached = McpMM.diagram.part.McpMMDiagramEditorPlugin.getInstance().getLinkConstraints();
		if (cached == null) {
	...
	public static class LinkConstraints {
		...
		*/
		...
		public boolean canCreateTareaServerMCPEjecutaOperacion_4003(McpMM.TareaServerMCP source,
			...
			if (target != null && (target.getEsEjecutadaOperacion() != null)) {
				return false;
			}
