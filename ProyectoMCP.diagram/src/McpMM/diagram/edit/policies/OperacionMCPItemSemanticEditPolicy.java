 ...
 * @generated
 */
public class OperacionMCPItemSemanticEditPolicy extends McpMM.diagram.edit.policies.McpMMBaseItemSemanticEditPolicy {

	/**
	* @generated
	*/
	public OperacionMCPItemSemanticEditPolicy() {
		super(McpMM.diagram.providers.McpMMElementTypes.OperacionMCP_3001);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (McpMM.diagram.part.McpMMVisualIDRegistry.getVisualID(
					incomingLink) == McpMM.diagram.edit.parts.TareaServerMCPEjecutaOperacionEditPart.VISUAL_ID) {
