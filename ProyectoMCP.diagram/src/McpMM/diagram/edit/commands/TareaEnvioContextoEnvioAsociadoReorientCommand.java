 ...
 * @generated
 */
public class TareaEnvioContextoEnvioAsociadoReorientCommand extends EditElementCommand {
	...
	* @generated
	*/
	public TareaEnvioContextoEnvioAsociadoReorientCommand(ReorientReferenceRelationshipRequest request) {
	...
	*/
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof McpMM.Propiedad && newEnd instanceof McpMM.TareaEnvioContexto)) {
			return false;
		}
		return McpMM.diagram.edit.policies.McpMMBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistTareaEnvioContextoEnvioAsociado_4010(getNewSource(), getOldTarget());
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		return McpMM.diagram.edit.policies.McpMMBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistTareaEnvioContextoEnvioAsociado_4010(getOldSource(), getNewTarget());
	}
	...
	*/
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().setEnvioAsociado(null);
		getNewSource().setEnvioAsociado(getOldTarget());
	...
	*/
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().setEnvioAsociado(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
