 ...
 * @generated
 */
public class AgenteRealizaReorientCommand extends EditElementCommand {
	...
	* @generated
	*/
	public AgenteRealizaReorientCommand(ReorientReferenceRelationshipRequest request) {
	...
	*/
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof McpMM.Tarea && newEnd instanceof McpMM.Agente)) {
			return false;
		}
		return McpMM.diagram.edit.policies.McpMMBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistAgenteRealiza_4001(getNewSource(), getOldTarget());
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		return McpMM.diagram.edit.policies.McpMMBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistAgenteRealiza_4001(getOldSource(), getNewTarget());
	}
	...
	*/
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().getRealiza().remove(getOldTarget());
		getNewSource().getRealiza().add(getOldTarget());
	...
	*/
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().getRealiza().remove(getOldTarget());
		getOldSource().getRealiza().add(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
