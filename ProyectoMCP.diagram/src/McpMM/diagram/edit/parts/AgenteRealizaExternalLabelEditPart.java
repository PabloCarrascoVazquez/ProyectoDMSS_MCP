 ...
 * @generated
 */
public class AgenteRealizaExternalLabelEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(McpMM.diagram.part.McpMMVisualIDRegistry
				.getType(McpMM.diagram.edit.parts.AgenteRealizaExternalLabelEditPart.VISUAL_ID), new Point(0, 40));
	}

	/**
	* @generated
	*/
	public AgenteRealizaExternalLabelEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = McpMM.diagram.providers.McpMMParserProvider.getParser(
					McpMM.diagram.providers.McpMMElementTypes.AgenteRealiza_4001, getParserElement(),
	...
	*/
	protected IFigure createFigurePrim() {
		return new AgenteRealizaExternalLabelFigure();
	}

	/**
	 * @generated
	 */
	public class AgenteRealizaExternalLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public AgenteRealizaExternalLabelFigure() {
			this.setText("realiza");
		}
