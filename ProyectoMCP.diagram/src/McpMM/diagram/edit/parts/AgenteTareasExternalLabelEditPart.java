 ...
 * @generated
 */
public class AgenteTareasExternalLabelEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(McpMM.diagram.part.McpMMVisualIDRegistry
				.getType(McpMM.diagram.edit.parts.AgenteTareasExternalLabelEditPart.VISUAL_ID), new Point(0, 40));
	}

	/**
	* @generated
	*/
	public AgenteTareasExternalLabelEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = McpMM.diagram.providers.McpMMParserProvider.getParser(
					McpMM.diagram.providers.McpMMElementTypes.AgenteTareas_4001, getParserElement(),
	...
	*/
	protected IFigure createFigurePrim() {
		return new AgenteTareasExternalLabelFigure();
	}

	/**
	 * @generated
	 */
	public class AgenteTareasExternalLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public AgenteTareasExternalLabelFigure() {
			this.setText("ejecuta");
		}
