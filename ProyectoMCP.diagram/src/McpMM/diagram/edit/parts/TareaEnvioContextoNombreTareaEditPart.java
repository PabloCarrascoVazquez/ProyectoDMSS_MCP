 ...
 * @generated
 */
public class TareaEnvioContextoNombreTareaEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public TareaEnvioContextoNombreTareaEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = McpMM.diagram.providers.McpMMParserProvider.getParser(
					McpMM.diagram.providers.McpMMElementTypes.TareaEnvioContexto_3008, getParserElement(),
