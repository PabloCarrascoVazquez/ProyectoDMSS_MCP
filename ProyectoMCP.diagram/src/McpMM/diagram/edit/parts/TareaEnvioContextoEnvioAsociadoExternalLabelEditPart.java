 ...
 * @generated
 */
public class TareaEnvioContextoEnvioAsociadoExternalLabelEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				McpMM.diagram.part.McpMMVisualIDRegistry.getType(
						McpMM.diagram.edit.parts.TareaEnvioContextoEnvioAsociadoExternalLabelEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	* @generated
	*/
	public TareaEnvioContextoEnvioAsociadoExternalLabelEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = McpMM.diagram.providers.McpMMParserProvider.getParser(
					McpMM.diagram.providers.McpMMElementTypes.TareaEnvioContextoEnvioAsociado_4010, getParserElement(),
	...
	*/
	protected IFigure createFigurePrim() {
		return new TareaEnvioContextoEnvioAsociadoExternalLabelFigure();
	}

	/**
	 * @generated
	 */
	public class TareaEnvioContextoEnvioAsociadoExternalLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public TareaEnvioContextoEnvioAsociadoExternalLabelFigure() {
			this.setText("envía prop.");
		}
