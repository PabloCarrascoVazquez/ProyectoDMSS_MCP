 ...
 * @generated
 */
public class TareaEnvioContextoEnviaAExternalLabelEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public TareaEnvioContextoEnviaAExternalLabelEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = McpMM.diagram.providers.McpMMParserProvider.getParser(
					McpMM.diagram.providers.McpMMElementTypes.TareaEnvioContextoEnviaA_4009, getParserElement(),
	...
	*/
	protected IFigure createFigurePrim() {
		return new TareaEnvioContextoEnviaAExternalLabelFigure();
	}

	/**
	 * @generated
	 */
	public class TareaEnvioContextoEnviaAExternalLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public TareaEnvioContextoEnviaAExternalLabelFigure() {
			this.setText("envía a");
		}
