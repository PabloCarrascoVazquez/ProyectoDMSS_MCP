 ...
 * @generated
 */
public class WorkflowFinalizaConExternalLabelEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(McpMM.diagram.part.McpMMVisualIDRegistry.getType(
				McpMM.diagram.edit.parts.WorkflowFinalizaConExternalLabelEditPart.VISUAL_ID), new Point(0, 40));
	}

	/**
	* @generated
	*/
	public WorkflowFinalizaConExternalLabelEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new McpMM.diagram.edit.policies.McpMMTextSelectionEditPolicy());
	...
	public IParser getParser() {
		if (parser == null) {
			parser = McpMM.diagram.providers.McpMMParserProvider.getParser(
					McpMM.diagram.providers.McpMMElementTypes.WorkflowFinalizaCon_4003, getParserElement(),
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null,
					McpMM.diagram.edit.parts.McpMMEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new WorkflowFinalizaConExternalLabelFigure();
	}

	/**
	 * @generated
	 */
	public class WorkflowFinalizaConExternalLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public WorkflowFinalizaConExternalLabelFigure() {
			this.setText("finaliza");
		}
