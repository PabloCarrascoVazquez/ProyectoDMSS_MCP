 ...
 * @generated
 */
public class WorkflowEmpiezaConExternalLabelEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(McpMM.diagram.part.McpMMVisualIDRegistry
				.getType(McpMM.diagram.edit.parts.WorkflowEmpiezaConExternalLabelEditPart.VISUAL_ID), new Point(0, 40));
	}

	/**
	* @generated
	*/
	public WorkflowEmpiezaConExternalLabelEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = McpMM.diagram.providers.McpMMParserProvider.getParser(
					McpMM.diagram.providers.McpMMElementTypes.WorkflowEmpiezaCon_4002, getParserElement(),
	...
	*/
	protected IFigure createFigurePrim() {
		return new WorkflowEmpiezaConExternalLabelFigure();
	}

	/**
	 * @generated
	 */
	public class WorkflowEmpiezaConExternalLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public WorkflowEmpiezaConExternalLabelFigure() {
			this.setText("empieza");
		}
