 ...
 * @generated
 */
public class TareaAnalisisSigueElseExternalLabelEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public TareaAnalisisSigueElseExternalLabelEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = McpMM.diagram.providers.McpMMParserProvider.getParser(
					McpMM.diagram.providers.McpMMElementTypes.TareaAnalisisSigueElse_4003, getParserElement(),
	...
	*/
	protected IFigure createFigurePrim() {
		return new TareaAnalisisSigueElseExternalLabelFigure();
	}

	/**
	 * @generated
	 */
	public class TareaAnalisisSigueElseExternalLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public TareaAnalisisSigueElseExternalLabelFigure() {
			this.setText("sigue Else");
		}
