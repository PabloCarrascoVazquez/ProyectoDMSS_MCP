...
public class ContextoEditPart extends ShapeNodeEditPart {
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new McpMM.diagram.edit.policies.ContextoItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof McpMM.diagram.edit.parts.ContextoNombreContextoEditPart) {
			((McpMM.diagram.edit.parts.ContextoNombreContextoEditPart) childEditPart)
	...
	*/
	 ...
	 * @generated
	 */
	public class ContextoFigure extends RectangleFigure {
