 ...
 * @generated
 */
public class WorkflowNombreWorkflowEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public WorkflowNombreWorkflowEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = McpMM.diagram.providers.McpMMParserProvider.getParser(
					McpMM.diagram.providers.McpMMElementTypes.Workflow_2003, getParserElement(),
