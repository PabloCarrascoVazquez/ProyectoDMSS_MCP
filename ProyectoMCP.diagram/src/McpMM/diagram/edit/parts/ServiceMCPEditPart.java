 ...
 * @generated
 */
public class ServiceMCPEditPart extends DiagramEditPart {

	/**
	* @generated
	*/
	public final static String MODEL_ID = "McpMM"; //$NON-NLS-1$
	...
	* @generated
	*/
	public ServiceMCPEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new McpMM.diagram.edit.policies.ServiceMCPItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new McpMM.diagram.edit.policies.ServiceMCPCanonicalEditPolicy());
			...
			private Command createShortcutsCommand(DropObjectsRequest dropRequest,
				...
				if (command != null) {
					return command.chain(
							new ICommandProxy(new McpMM.diagram.edit.commands.McpMMCreateShortcutDecorationsCommand(
