 ...
 * @generated
 */
public class TareaFinalNombreTareaEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public TareaFinalNombreTareaEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = McpMM.diagram.providers.McpMMParserProvider.getParser(
					McpMM.diagram.providers.McpMMElementTypes.TareaFinal_3011, getParserElement(),
