 ...
 * @generated
 */
public class TareaSigueExternalLabelEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(McpMM.diagram.part.McpMMVisualIDRegistry
				.getType(McpMM.diagram.edit.parts.TareaSigueExternalLabelEditPart.VISUAL_ID), new Point(0, 40));
	}

	/**
	* @generated
	*/
	public TareaSigueExternalLabelEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = McpMM.diagram.providers.McpMMParserProvider.getParser(
					McpMM.diagram.providers.McpMMElementTypes.TareaSigue_4004, getParserElement(),
	...
	*/
	protected IFigure createFigurePrim() {
		return new TareaSigueExternalLabelFigure();
	}

	/**
	 * @generated
	 */
	public class TareaSigueExternalLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public TareaSigueExternalLabelFigure() {
			this.setText("sigue");
		}
