...
public class MessageFormatParser extends AbstractAttributeParser {
	...
	*/
	public IParserEditStatus isValidEditString(IAdaptable adapter, String editString) {
		...
		if (values == null) {
			return new ParserEditStatus(McpMM.diagram.part.McpMMDiagramEditorPlugin.ID, IParserEditStatus.UNEDITABLE,
					NLS.bind(McpMM.diagram.part.Messages.MessageFormatParser_InvalidInputError,
