 ...
 * @generated
 */
public class McpMMValidationDecoratorProvider extends AbstractProvider implements IDecoratorProvider {
	...
	* @generated
	*/
	private static final String MARKER_TYPE = McpMM.diagram.part.McpMMDiagramEditorPlugin.ID + ".diagnostic"; //$NON-NLS-1$
	...
	*/
	public void createDecorators(IDecoratorTarget decoratorTarget) {
		...
		if (editPart instanceof GraphicalEditPart || editPart instanceof AbstractConnectionEditPart) {
			...
			if (((DiagramEditDomain) ed).getEditorPart() instanceof McpMM.diagram.part.McpMMDiagramEditor) {
	...
	*/
	public boolean provides(IOperation operation) {
		...
		return view != null && McpMM.diagram.edit.parts.ServiceMCPEditPart.MODEL_ID
		...
		PlatformUI.getWorkbench().getDisplay().asyncExec(new Runnable() {
			...
			public void run() {
				try {
					...
					McpMM.diagram.part.McpMMDiagramEditorPlugin.getInstance().logError("Decorator refresh failure", e); //$NON-NLS-1$
				}
			}
		});
	}
		...
		*/
		public StatusDecorator(IDecoratorTarget decoratorTarget) {
			...
			try {
				...
				McpMM.diagram.part.McpMMDiagramEditorPlugin.getInstance().logError("ViewID access failure", e); //$NON-NLS-1$			
			}
		}
		...
		*/
		public void refresh() {
			...
			try {
				...
				McpMM.diagram.part.McpMMDiagramEditorPlugin.getInstance().logError("Validation markers refresh failure", //$NON-NLS-1$
						e);
			}
		...
		*/
		private String getType(IMarker marker) {
			try {
				...
				McpMM.diagram.part.McpMMDiagramEditorPlugin.getInstance().logError("Validation marker refresh failure", //$NON-NLS-1$
						e);
				return ""; //$NON-NLS-1$
			}
		}
