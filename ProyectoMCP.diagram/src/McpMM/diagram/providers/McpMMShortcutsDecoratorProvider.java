 ...
 * @generated
 */
public class McpMMShortcutsDecoratorProvider extends AbstractProvider implements IDecoratorProvider {
	...
	protected class ShortcutsDecorator extends AbstractDecorator {
		...
		*/
		public void refresh() {
			...
			Image image = McpMM.diagram.part.McpMMDiagramEditorPlugin.getInstance()
