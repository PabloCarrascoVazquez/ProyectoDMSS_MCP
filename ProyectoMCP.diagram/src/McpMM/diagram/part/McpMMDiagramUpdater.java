...
public class McpMMDiagramUpdater {
	...
	*/
	public static List<McpMM.diagram.part.McpMMNodeDescriptor> getServiceMCP_1000SemanticChildren(View view) {
		...
		for (Iterator<?> it = modelElement.getAgentes().iterator(); it.hasNext();) {
		...
		for (Iterator<?> it = modelElement.getServidores().iterator(); it.hasNext();) {
	...
	*/
	public static List<McpMM.diagram.part.McpMMNodeDescriptor> getAgenteAgenteContextosCompartment_7002SemanticChildren(
		...
		McpMM.Agente modelElement = (McpMM.Agente) containerView.getElement();
		LinkedList<McpMM.diagram.part.McpMMNodeDescriptor> result = new LinkedList<McpMM.diagram.part.McpMMNodeDescriptor>();
		for (Iterator<?> it = modelElement.getContextos().iterator(); it.hasNext();) {
	...
	*/
	public static List<McpMM.diagram.part.McpMMNodeDescriptor> getWorkflowWorkflowTareasCompartment_7003SemanticChildren(
		...
		for (Iterator<?> it = modelElement.getTareas().iterator(); it.hasNext();) {
			...
			if (visualID == McpMM.diagram.edit.parts.InicioEditPart.VISUAL_ID) {
				result.add(new McpMM.diagram.part.McpMMNodeDescriptor(childElement, visualID));
				continue;
			}
			if (visualID == McpMM.diagram.edit.parts.FinalEditPart.VISUAL_ID) {
				result.add(new McpMM.diagram.part.McpMMNodeDescriptor(childElement, visualID));
				continue;
			}
		}
	...
	*/
	public static List<McpMM.diagram.part.McpMMNodeDescriptor> getInicioInicioAccionCompartment_7011SemanticChildren(
		...
		McpMM.Inicio modelElement = (McpMM.Inicio) containerView.getElement();
		LinkedList<McpMM.diagram.part.McpMMNodeDescriptor> result = new LinkedList<McpMM.diagram.part.McpMMNodeDescriptor>();
		for (Iterator<?> it = modelElement.getAccion().iterator(); it.hasNext();) {
			McpMM.Accion childElement = (McpMM.Accion) it.next();
			int visualID = McpMM.diagram.part.McpMMVisualIDRegistry.getNodeVisualID(view, childElement);
	...
	*/
	public static List<McpMM.diagram.part.McpMMNodeDescriptor> getFinalFinalAccionCompartment_7012SemanticChildren(
		...
		McpMM.Final modelElement = (McpMM.Final) containerView.getElement();
		LinkedList<McpMM.diagram.part.McpMMNodeDescriptor> result = new LinkedList<McpMM.diagram.part.McpMMNodeDescriptor>();
		for (Iterator<?> it = modelElement.getAccion().iterator(); it.hasNext();) {
			McpMM.Accion childElement = (McpMM.Accion) it.next();
			int visualID = McpMM.diagram.part.McpMMVisualIDRegistry.getNodeVisualID(view, childElement);
	...
	*/
	public static List<McpMM.diagram.part.McpMMLinkDescriptor> getContainedLinks(View view) {
		...
		case McpMM.diagram.edit.parts.AgenteEditPart.VISUAL_ID:
			return getAgente_2001ContainedLinks(view);
	...
	*/
	public static List<McpMM.diagram.part.McpMMLinkDescriptor> getIncomingLinks(View view) {
		switch (McpMM.diagram.part.McpMMVisualIDRegistry.getVisualID(view)) {
		case McpMM.diagram.edit.parts.AgenteEditPart.VISUAL_ID:
			return getAgente_2001IncomingLinks(view);
		case McpMM.diagram.edit.parts.ServerMCPEditPart.VISUAL_ID:
	...
	*/
	public static List<McpMM.diagram.part.McpMMLinkDescriptor> getOutgoingLinks(View view) {
		switch (McpMM.diagram.part.McpMMVisualIDRegistry.getVisualID(view)) {
		case McpMM.diagram.edit.parts.AgenteEditPart.VISUAL_ID:
			return getAgente_2001OutgoingLinks(view);
		case McpMM.diagram.edit.parts.ServerMCPEditPart.VISUAL_ID:
	 ...
	 * @generated
	 */
	public static List<McpMM.diagram.part.McpMMLinkDescriptor> getServerMCP_2002ContainedLinks(View view) {
		return Collections.emptyList();
	}
	 ...
	 * @generated
	 */
	public static List<McpMM.diagram.part.McpMMLinkDescriptor> getAgente_2001IncomingLinks(View view) {
		return Collections.emptyList();
	}
	 ...
	 * @generated
	 */
	public static List<McpMM.diagram.part.McpMMLinkDescriptor> getServerMCP_2002IncomingLinks(View view) {
		return Collections.emptyList();
	}
	 ...
	 * @generated
	 */
	public static List<McpMM.diagram.part.McpMMLinkDescriptor> getServerMCP_2002OutgoingLinks(View view) {
		return Collections.emptyList();
	}
