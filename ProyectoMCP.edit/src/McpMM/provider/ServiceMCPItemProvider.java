...
/**
 * This is the item provider adapter for a {@link McpMM.ServiceMCP} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ServiceMCPItemProvider 
	 ...
	 * @generated
	 */
	public ServiceMCPItemProvider(AdapterFactory adapterFactory) {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addNombreServicioPropertyDescriptor(object);
		}
		return itemPropertyDescriptors;
	}

	/**
	 * This adds a property descriptor for the Nombre Servicio feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addNombreServicioPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ServiceMCP_nombreServicio_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ServiceMCP_nombreServicio_feature", "_UI_ServiceMCP_type"),
				 McpMMPackage.Literals.SERVICE_MCP__NOMBRE_SERVICIO,
				 true,
				 false,
				 false,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ServiceMCP"));
	}
	...
	public String getText(Object object) {
		String label = ((ServiceMCP)object).getNombreServicio();
		return label == null || label.length() == 0 ?
			getString("_UI_ServiceMCP_type") :
			getString("_UI_ServiceMCP_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ServiceMCP.class)) {
