...
/**
 * This is the item provider adapter for a {@link McpMM.Propiedad} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PropiedadItemProvider 
	 ...
	 * @generated
	 */
	public PropiedadItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This adds a property descriptor for the Nombre Propiedad feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addNombrePropiedadPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Propiedad_nombrePropiedad_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Propiedad_nombrePropiedad_feature", "_UI_Propiedad_type"),
				 McpMMPackage.Literals.PROPIEDAD__NOMBRE_PROPIEDAD,
				 true,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the Tipo Propiedad feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addTipoPropiedadPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Propiedad_tipoPropiedad_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Propiedad_tipoPropiedad_feature", "_UI_Propiedad_type"),
				 McpMMPackage.Literals.PROPIEDAD__TIPO_PROPIEDAD,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	 ...
	 * @generated
	 */
	protected void addEsUsadaPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Propiedad_esUsada_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Propiedad_esUsada_feature", "_UI_Propiedad_type"),
				 McpMMPackage.Literals.PROPIEDAD__ES_USADA,
				 true,
				 false,
				 true,
				 null,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Propiedad"));
	}
	...
	public String getText(Object object) {
		String label = ((Propiedad)object).getNombrePropiedad();
		return label == null || label.length() == 0 ?
			getString("_UI_Propiedad_type") :
			getString("_UI_Propiedad_type") + " " + label;
	}
